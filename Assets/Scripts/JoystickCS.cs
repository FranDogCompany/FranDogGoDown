...
{
	public class JoystickCS : MonoBehaviour, ISimpleInputDraggable
	{
		//自己寫的
...
#pragma warning restore 0649
		...
		void Update()
		{
			...
			// 	playerIdle.transform.position += new Vector3(speed*Time.deltaTime, 0, 0);
			// }
			// //類比搖桿_左移動
			// if (xAxis.value < -0.5)
            // {
			...
			// 	playerIdle.transform.position += new Vector3(0, speed*Time.deltaTime, 0);
			// }
